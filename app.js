(function () {
    ...
    function resetTextInput() {
        if (textInput.style.display == "block") {
            ...
            const inputVal = textInput.innerHTML; // Use innerHTML
    ...
    function updateTextInput(value, focus) {
        textInput.innerHTML = value; // Use innerHTML
        console.log('updating text input');
        if (focus) {
            textInput.focus();
            // Move cursor to end (for divs)
        ...
        findCellNamesAndHighlight(textInput.innerHTML); // Use innerHTML
    }
    ...
    function displayInput() {
        ...
        const pos = DrawFunctions.getCellPosition(selectedCell.row, selectedCell.col); // Use DrawFunctions.getCellPosition
        ...
        textInput.value = spreadsheetData[selectedCell.row][selectedCell.col]; // Set value, not innerHTML
        textInput.focus();
        textInput.style.padding = '5px';
        textInput.style.background = "#fff";
        textInput.style.textBaseline = "center";
        textInput.style.outline = "4px solid rgba(0,0,255,0.8)";
        updateTextInput(spreadsheetData[selectedCell.row][selectedCell.col], focus=true); // Use updateTextInput
    }
